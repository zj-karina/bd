...
import com.romanova.bd.repository.TrainingPaidBasisRepository;
...
@Controller
@RequestMapping("/paid_basis_of_training")
@AllArgsConstructor
public class TrainingPaidBasisController {
    private static final List<String> HEADERS =
            List.of("payment_receipt_number", "availability_of_original_certificate");
    ...
    private final TrainingPaidBasisRepository repository;
    ...
    public String getAll(Model model, @PathVariable String action){
        ...
        switch (action){
            case "SELECT_ALL":
                ...
                return "objects/paid_basis_of_training/all";
            case "SELECT_BY_ID":
            case "SELECT_LIKE":
            case "SELECT_WHERE":
            case "ORDER_BY":
            ...
            case "DELETE":
                return "input";
            case "INSERT":
                return "objects/paid_basis_of_training/insert";
        }
    ...
    public void modelParameters(Model model){
        ...
        model.addAttribute("table", "paid_basis_of_training");
    }
}
